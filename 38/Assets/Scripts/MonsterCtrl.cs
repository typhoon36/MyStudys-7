...
public class MonsterCtrl : MonoBehaviour
{
    ...
    //## 스폰
    [HideInInspector] public int m_SpawnIdx = -1; //m_SpawnPosList의 인덱스 번호
    ...
    public void SetSpawnInfo(int Idx, int a_LV, float a_MaxHp, float a_AttSpd, float a_MvSpd)
    {
        m_SpawnIdx = Idx;
        m_Level = a_LV;
        //m_MaxHp = a_MaxHp;
        //m_CurHp = m_MaxHp;
        //m_AttackSpeed = a_AttSpd;
        //m_MoveVelocity = a_MvSpd;
